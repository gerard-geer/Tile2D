...
private:
    ...
    /**
     * @brief Compiles a shader object. Any compilation errors are directed to stderr.
     * @param source The source code, as an array of strings.
     * @param numLines The number of lines in source.
